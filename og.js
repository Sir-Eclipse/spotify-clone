...
const Header = () => {
  ...
  return (
    ...
    React.createElement("i", { class: "fa fa-user-circle fa-lg", "aria-hidden": "true" }), "Pratham Agarwal", 
    ...
    React.createElement("li", null, React.createElement("a", { href: "https://github.com/Sir-Eclipse", target: "_blank" }, "Account", React.createElement("i", { class: "fa fa-external-link", "aria-hidden": "true" }))), 

    React.createElement("li", null, React.createElement("a", { href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" }, "Profile")), 
    React.createElement("li", null, React.createElement("a", { href: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" }, "Log Out")))))));
